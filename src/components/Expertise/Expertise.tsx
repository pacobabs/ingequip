  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container flex flex-col-reverse items-center px-4 py-8 mx-auto md:flex-row-reverse">
        ...
        <div className="flex flex-col items-center text-center lg:flex-grow md:w-1/2 lg:pl-24 md:px-8 md:items-start md:text-left">
          <h1 className="text-gray-900">OUR EXPERTISE</h1>
